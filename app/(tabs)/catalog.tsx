...
import { Package, Search, Filter, Star, Camera, Upload, Plus } from 'lucide-react-native';
...
export default function CatalogScreen() {
  ...
  const categories = ['All', 'Wiring', 'Safety', 'Lighting', 'Controls', 'Accessories', 'Tools'];
        ...
        <View style={styles.productsGrid}>
          {filteredProducts.length > 0 ? (
            filteredProducts.map((product) => (
              <TouchableOpacity key={product._id} style={[styles.productCard, { backgroundColor: colors.surface }]}>
                <View style={styles.productContent}>
                  <View style={styles.productMainContent}>
                    <View style={styles.productInfo}>
                      ...
                      <Text style={[styles.productUnits, { color: colors.textSecondary }]}>
                        Units: {product.units}
                      </Text>
                    </View>
